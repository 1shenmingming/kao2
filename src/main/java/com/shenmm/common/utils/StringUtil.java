...
public class StringUtil {
  static String[] uname = { "赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈", "楮", "卫", "蒋", "沈", "韩", "杨",
    ...
    "阳", "佟", "万俟", "司马", "上官", "欧阳", "夏侯", "诸葛", "闻人", "东方", "赫连", "皇甫", "尉迟", "公羊", "澹台", "公冶", "宗政", "濮阳",
    "淳于", "单于", "太叔", "申屠", "公孙", "仲孙", "轩辕", "令狐", "锺离", "宇文", "长孙", "慕容", "鲜于", "闾丘", "司徒", "司空", "丌官",
    "司寇", "仉", "督", "子车", "颛孙", "端木", "巫马", "公西", "漆雕", "乐正", "壤驷", "公良", "拓拔", "夹谷", "宰父", "谷梁", "段干", "百里",
   ...
   */
  public static String randomoneChineseString() throws UnsupportedEncodingException {
    //TODO 实现代码
    Random r = new Random();
    String sl = "";
    char stri = (char) (r.nextInt(42198 - 21986 + 1) + 21986);
    sl += stri;
    if (sl.equals(new String(sl.getBytes("GB2312"), "GB2312")))
      return sl;
    return randomoneChineseString();
  }
  ...
  public static String randomChineseString(int length) throws UnsupportedEncodingException {
    ...
    for (int i = 0; i < length; i++) {
      sb.append(StringUtil.randomoneChineseString());
    }
    return sb.toString();
  }
  ...
  public static String generateChineseName() throws UnsupportedEncodingException {
    //TODO 实现代码
    Random r = new Random();
    int i = r.nextInt(uname.length);
    String pname = uname[i];
    if (r.nextBoolean()) {
      pname += StringUtil.randomoneChineseString() + StringUtil.randomoneChineseString();
    } else {
      pname += StringUtil.randomoneChineseString();
    }
    return pname;
  }
}
